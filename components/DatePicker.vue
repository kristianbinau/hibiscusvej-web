...
const props = defineProps({
	...
	attributes: {
		type: Array as PropType<AttributeConfig[]>,
		default: () => [],
	},
	disabledDates: {
		type: Array as PropType<DateRangeSource[]>,
		default: () => [],
	},
	minDate: {
		type: Date,
...
const emit = defineEmits(['update:model-value', 'close', 'didMove']);
...
function onDidMove(event: Page[]): void {
	emit('didMove', event);
}
</script>
